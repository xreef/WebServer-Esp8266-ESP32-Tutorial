/*
 *  ESP32 and AsyncWebServer library
 ...
 *
 *  Grab data from DHT12 sensor and show via animated widget
 *
 *  Animated widget https://github.com/xreef/JS-Vanilla-and-React-temperature-humidity
 *
